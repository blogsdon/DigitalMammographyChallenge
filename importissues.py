...
def main(argv=None):
    ...
    repository = gh.repository('Sage-Bionetworks', 'ampadknowledgeportal')
    ...
    while offset<totalNumberOfResults:
        ...
        for thread in threads.get('results'):
            ...
            repository.create_issue(title=thread.get('title'), assignee="blogsdon", body='https://www.synapse.org/#!Synapse:'+projectId+'/discussion/threadId='+str(thread.get('id')), labels=['discussion forum'])
